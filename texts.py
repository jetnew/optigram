...
header2 = "Singapore's Energy Consumption Landscape"
section2 = """Households only accounted for 5.0% of energy consumption out of Singapore’s total energy consumption, primarily in the form of electricity (i.e. 652.6 ktoe) and natural gas by way of town gas (i.e. 60.9 ktoe). (Singapore Energy Statistics)
